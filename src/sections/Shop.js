...
const Shop = () => {
  ...
  useLayoutEffect(() => {
    let ctx = gsap.context(() => {
      ...
      // بنستنى ثانية واحدة لحد ما الصور والـ DOM يحملوا أبعادهم الحقيقية
      setTimeout(() => {
        ...
        // بنقول لـ ScrollTrigger يراجع حساباته بعد ما الـ timeline اتعمل
        ScrollTrigger.refresh();
      }, 1000);
    });

    return () => {
      ctx.revert(); // هينضف كل حاجة لما تمشي من الصفحة بدون Errors
    };
  }, []);
