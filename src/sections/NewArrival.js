...
const NewArrival = () => {
  ...
  useLayoutEffect(() => {
    // 1. استخدام الـ context عشان التنظيف التلقائي
    let ctx = gsap.context(() => {
      ...
      setTimeout(() => {
        // تأكد إن العناصر موجودة عشان ميرميش error
        ...
        t1.to(element, {
          ...
          ease: "none", // شيلنا الفاصلة الزيادة اللي كانت هنا
        });
    ...
    return () => {
      // 2. التنظيف الآمن بدل ScrollTrigger.kill()
      ctx.revert();
    };
  }, []);
